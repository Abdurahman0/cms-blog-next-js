		...
		<div className='max-w-6xl mx-auto'>
			...
			<div className='max-w-6xl mx-auto mt-12 flex flex-col text-center space-y-4 text-muted-foreground'>
				<p>
					...
					is definitely your about page. It is your chance to show your readers
				...
				<p>
					I have included a plugin in the setup of this theme that will make
					adding columns to your pages and posts a piece of cake. Let creativity
					take control, and forget about the technical end of things, I have got
					your six.
				</p>
			</div>
